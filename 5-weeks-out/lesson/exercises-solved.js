...
//when you declare a variable and assign a value to it, JavaScript will read the right side of the equation, evaluate the value, and store the value in the left side (in the variable name). That variable name now represents that value.
...
//functions are little bits of code that you want to run over and over and over again. You can pass the function "raw materials" and get out a "finished product." In this example, we are passing the function numbers as raw materials and getting the sum as the finished product.
